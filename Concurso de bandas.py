...
class ConcursoBanda:
    def __init__(self, ventana):
        ...
        etiqueta = tk.Label(ventana, text="SISTEMA DE CONCURSO DE BANDAS", font=("georgia", 35, "underline"), fg="goldenrod", bg="beige")
        etiqueta.pack(pady=5)
        self.concurso = Concurso("Concurso de bandas - 14 de Septiembre", "2025-09-14")

        boton_inscribir_banda = tk.Button(self.ventana, text="Inscribir Banda", command=self.inscribir_banda,font=("georgia", 13, "italic"), fg="dark slate gray", bg= "beige")
        boton_inscribir_banda.pack(pady=5)

        boton_registrar_evaluacion = tk.Button(self.ventana, text="Registrar Evaluacion", command=self.registrar_evaluacion,font=("georgia", 13, "italic"), fg="dark slate gray", bg= "beige")
        boton_registrar_evaluacion.pack(pady=5)

        boton_listar_bandas = tk.Button(self.ventana, text="Listar Bandas", command=self.listar_bandas,font=("georgia", 13, "italic"), fg="dark slate gray", bg= "beige")
        boton_listar_bandas.pack(pady=5)

        boton_ver_ranking = tk.Button(self.ventana, text="Ver Ranking", command=self.ver_ranking,font=("georgia", 13, "italic"), fg="dark slate gray", bg= "beige")
        boton_ver_ranking.pack(pady=5)

        boton_guardar = tk.Button(self.ventana, text="Guardar Resultados", command=self.guardar_archivo,font=("georgia", 13, "italic"), fg="dark slate gray", bg= "beige")
        boton_guardar.pack(pady=5)

        boton_salir = tk.Button(self.ventana, text="Salir", command=self.ventana.quit, font=("georgia", 13, "italic"), fg="dark slate gray", bg= "beige")
    ...
    def inscribir_banda(self):
        ...
        tk.Button(ventana_form, text="Guardar", command=guardar).pack(pady=10)
    ...
    def registrar_evaluacion(self):
        ...
        tk.Button(ventana_evalua, text="Guardar Evaluación", command=guardar_evalua).pack(pady=10)
    ...
    def ver_ranking(self):
        ...
        if not ranking:
            tk.Label(ventana_ranking, text="No hay evaluaciones registradas").pack(pady=5)
        else:
    ...
    def guardar_archivo(self):
        ...
        tk.Label(ventana_msg, text=mensaje).pack(pady=10)
